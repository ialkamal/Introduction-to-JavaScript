...
function RockPaperScissors(inputChoice) {
  ...
  if (inputChoice.toLowerCase() === "rock") {
    myChoice = 0;
  } else if (inputChoice.toLowerCase() === "paper") {
    myChoice = 1;
  } else if (inputChoice.toLowerCase() === "scissors") {
    myChoice = 2;
  }

  const computerChoice = Math.floor(3 * Math.random());
...
console.log(
  'Number of vowels in "' + randomString + '" is ' + vowelsCount(randomString)
);
console.log("\n");
...
const myChoice = prompt(
  "To Play, Enter 0 for Rock, 1 for Paper or 2 for Scissors"
);
